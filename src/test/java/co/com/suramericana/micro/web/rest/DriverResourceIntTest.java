...
public class DriverResourceIntTest {
    ...
    public void createDriver() throws Exception {
        ...
        assertThat(testDriver.getNombre()).isEqualTo(DEFAULT_NOMBRE);
        assertThat(testDriver.getApellido()).isEqualTo(DEFAULT_APELLIDO);
    }
    ...
    public void updateDriver() throws Exception {
        ...
        Driver testDriver = driverList.get(driverList.size() - 1);
        assertThat(testDriver.getNombre()).isEqualTo(UPDATED_NOMBRE);
        assertThat(testDriver.getApellido()).isEqualTo(UPDATED_APELLIDO);
    }
